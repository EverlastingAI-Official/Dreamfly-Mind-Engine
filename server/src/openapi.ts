...
const schemas:Record<string,unknown>={
  ...
  '/skills/:id/publish':object({listed:{type:'boolean'},chat:{type:'boolean'},download:{type:'boolean'},github:{type:'boolean'},memory_ids:{type:'array',items:string},asset_keys:{type:'array',items:string}}),
